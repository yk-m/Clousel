        ...
        React.createElement("div", null, 
          ...
          React.createElement("div", {className: "p-item__caption"}, 
            ...
            React.createElement("dl", null, 
              ...
              React.createElement("dd", null, this.props.category.title)
            )
          )
        )
      )
...
var ItemList = React.createClass({displayName: "ItemList",
  render: function() {
    var itemNodes = this.props.data.map(function(item) {
      return (
        React.createElement(Item, {price: item.price, image: item.image, category: item.category.title, key: item.pk})
      );
    });
    return (
