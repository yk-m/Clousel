      ...
      React.createElement("a", {className: "p-item", href: "#"}, 
        React.createElement("div", null, 
          React.createElement("div", {className: "p-item__image"}, 
            React.createElement("div", null, React.createElement("img", {src: this.props.image}))
          ), 
          React.createElement("div", {className: "p-item__caption"}, 
            ...
            React.createElement("dl", null, 
              ...
              React.createElement("dd", null, this.props.category.join(" > "))
            )
          )
        )
      )
...
var ItemList = React.createClass({displayName: "ItemList",
  render: function() {
    var itemNodes = this.props.data.map(function(item) {
      return (
        React.createElement(Item, {price: item.price, image: item.image, category: item.category.tree, key: item.pk})
      );
    });
    return (
      React.createElement("div", null, 
